...
unfold Vide in H0.
absurd (In v2 (vide var_vide)); auto with zfc v62.
...
absurd (In y (vide var_vide)); auto with zfc v62.
...
absurd (In a (vide var_vide)); auto with zfc v62.
...
elim (lem_inter_propertie a b v2); intros; split; intros; auto with zfc v62.
...
elim H; clear H; unfold def_F_inter in |- *; intros; auto with zfc v62.
...
exists a; split; [ apply lem_x_in_sing_x | idtac ]; auto with zfc v62.

unfold singleton in H0.
elim (axs_paire a a v3); intros; generalize (H1 H0); clear H0 H1 H2; intros.
elim H0; clear H0; intros; rewrite H0; auto with zfc v62.
...
elim (axs_comprehension (def_F_inter b) a v2); intros; apply H4; clear H3 H4;
 intros.
unfold def_F_inter in |- *; split; auto with zfc v62.
...
unfold iff in |- *; split; intros.
clear H0; clear H1; apply H2; apply lem_and_sym; apply H; auto with zfc v62.

clear H; clear H2; apply H0; apply lem_and_sym; apply H1; auto with zfc v62.
...
apply H3; clear H3; apply H; clear H; auto with zfc v62.

clear H; clear H2; clear H3; clear H6; clear H7.
apply H0; clear H0; apply H4; clear H4; apply H8; clear H8.
apply H5; clear H5; apply H1; clear H1; auto with zfc v62.
...
unfold iff in |- *; split; intros.
clear H0; clear H1.
apply H2; clear H2; apply lem_or_sym; apply H; clear H; auto with zfc v62.

clear H; clear H2.
apply H0; clear H0; apply lem_or_sym; apply H1; clear H1; auto with zfc v62.
...
apply lem_and_sym; apply H7; clear H7; apply H; clear H; auto with zfc v62.

clear H; clear H2; clear H4; clear H6; clear H7.
apply H0; clear H0; apply H8; clear H8.
apply lem_and_sym; apply lem_and_dist.
apply H5; clear H5; apply H3; clear H3; apply H1; clear H1; auto with zfc v62.

apply lem_union_propertie.

unfold iff in |- *; split; intros; apply lem_and_sym; auto with zfc v62.
...
elim
 (lem_and_rew_lr (In v2 a \/ In v2 b) (In v2 a \/ In v2 c)
    (In v2 b \/ In v2 a) (In v2 c \/ In v2 a)); intros;
 [ idtac
 | unfold iff in |- *; split; intros; apply lem_or_sym; auto with zfc v62
 | unfold iff in |- *; split; intros; apply lem_or_sym; auto with zfc v62 ].
apply H4; clear H4; apply lem_or_fact; apply lem_or_sym; apply H5; clear H5;
 apply H; clear H; auto with zfc v62.
...
elim
 ...
 | unfold iff in |- *; split; intros; apply lem_or_sym; auto with zfc v62
 | unfold iff in |- *; split; intros; apply lem_or_sym; auto with zfc v62 ].
apply H6; clear H6; apply H3; clear H3; apply H1; clear H1; auto with zfc v62.
...
elim H0; clear H0 H1; intros; [ idtac | auto with zfc v62 ].
elim H0; clear H0; intros; unfold Vide in |- *; unfold Vide in H;
 elim (lem_vide_propertie x var_vide); auto with zfc v62.
...
apply H0; clear H H0; left; auto with zfc v62.
...
unfold iff in |- *; split; intros.
elim H; clear H H0; intros; auto with zfc v62.
...
unfold Vide in H; elim (lem_vide_propertie v0 var_vide); auto with zfc v62.
